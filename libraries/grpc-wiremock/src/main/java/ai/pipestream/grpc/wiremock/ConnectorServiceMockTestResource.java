...
/**
 * Quarkus test resource for mocking connector-service.
 * <p>
 * Starts WireMock with gRPC extension and configures Stork static discovery
 * to route connector-service calls to WireMock instead of Consul.
 * <p>
 * Usage:
 * <pre>
 * {@code
 ...
 * </pre>
 */
public class ConnectorServiceMockTestResource implements QuarkusTestResourceLifecycleManager {
     ...
     * Default constructor.
     */
    public ConnectorServiceMockTestResource() {
    }
    ...
    public Map<String, String> start() {
        ...
        // Return Stork configuration to route connector-service to WireMock
