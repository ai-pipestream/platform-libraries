...
import static ai.pipestream.grpc.wiremock.WireMockGrpcCompat.equalToMessage;
...
public class WireMockGrpcVerifier {
    ...
    /**
     * Creates a verifier for the given WireMock server.
     *
     * @param wireMockServer The WireMock server instance
     */
    public WireMockGrpcVerifier(WireMockServer wireMockServer) {
        this.wireMockServer = wireMockServer;
        this.wireMock = new WireMock(wireMockServer.port());
    }
    ...
    public void verifyMethodCalledWith(String serviceName, String methodName, MessageOrBuilder expectedRequest) {
        ...
        RequestPatternBuilder pattern = RequestPatternBuilder.newRequestPattern()
            ...
            .withRequestBody(equalToMessage(expectedRequest));
        
        com.github.tomakehurst.wiremock.verification.VerificationResult result = 
            wireMockServer.countRequestsMatching(pattern.build());
