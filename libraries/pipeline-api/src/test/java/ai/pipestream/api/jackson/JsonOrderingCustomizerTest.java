package ai.pipestream.api.jackson;
...
public class JsonOrderingCustomizerTest {
    ...
    void testMapEntriesAreSortedByKeys() throws Exception {
        ...
        assertEquals("{\"apple\":\"first\",\"banana\":\"second\",\"middle\":\"center\",\"zebra\":\"last\"}", json);
    }
    ...
    void testObjectPropertiesAreSortedAlphabetically() throws Exception {
        ...
        assertEquals("{\"afield\":\"a-value\",\"bfield\":\"b-value\",\"mfield\":\"m-value\",\"zfield\":\"z-value\"}", json);
    }
    ...
    void testNestedMapsAreSorted() throws Exception {
        ...
        assertTrue(json.contains("\"first\":{\"a\":\"1\",\"z\":\"26\"}"));
        assertTrue(json.contains("\"second\":{\"alpha\":\"1\",\"beta\":\"2\"}"));
        assertTrue(Pattern.matches(".*first.*second.*", json)); // First should come before second
    }
    ...
    void testSchemaFingerprintConsistency() throws Exception {
        ...
        assertEquals("{\"properties\":{\"chunkSize\":{\"default\":1000,\"type\":\"integer\"},\"overlap\":{\"default\":100,\"type\":\"integer\"}},\"required\":[\"chunkSize\"],\"type\":\"object\"}", json);
    }
